...
Listed below are all effects that can be used with functions like [sm.effect.playEffect](/docs/Game-Script-Environment/Static-Functions/sm.effect#playeffect).
